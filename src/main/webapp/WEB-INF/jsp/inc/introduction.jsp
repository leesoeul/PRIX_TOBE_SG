		...
		<td><table width="100%" height="88" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<tr>
					  ...
					  <% if( session.getAttribute("id") == null || session.getAttribute("id").equals("4") ) { %>
							<a href="/login" class="top_menu">LOG&nbsp;&nbsp;I&nbsp;N</a>
						  </td>
					  <% } else {%>
							<a href="/login?action=logout" class="top_menu">LOGOUT</a></td>
							<td><img src="/images/top_icon_01.gif" width="2" height="9">&nbsp;
							<a href="/deleteAccount" class="top_menu">DELETE ACCOUNT</a>
							</td>
					  <% } %>

                      <td><img src="/images/top_icon_01.gif" width="2" height="9">&nbsp;&nbsp;<a href="/help" class="top_menu">HELP</a></td>
                      <td><img src="/images/top_icon_01.gif" width="2" height="9">&nbsp;&nbsp;<a href="/contact" class="top_menu">CONTACT</a></td>
					  <td><img src="/images/top_icon_01.gif" width="2" height="9">&nbsp;&nbsp;<a href="/admin/adlogin" class="top_menu">ADMIN</a></td>
					  <td> &nbsp;</td>
					</tr>
                  </table></td>
				</tr>
				...
				<tr>
					<td valign="bottom"><table border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td><a href="/"><img src="/images/menu01_01.gif" width="142" height="29" border="0"></a></td>
						<td><a href="/livesearch"><img src="/images/menu01_02.gif" width="135" height="29" border="0"></a></td>
						<td><a href="/download"><img src="/images/menu01_03.gif" width="133" height="29" border="0"></a></td>
						<td><a href="/publications"><img src="/images/menu01_04.gif" width="157" height="29" border="0"></a></td>
					  </tr>
					</table></td>
				</tr>
