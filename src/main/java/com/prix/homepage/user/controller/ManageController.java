    ...
    public String manage(HttpServletRequest request, RedirectAttributes redirectAttributes) {
        ...
        try {
            ...
            if (deleteEnzymeId != null) {
                enzymeService.deleteEnzyme(Integer.parseInt(deleteEnzymeId), userId);
                ...
                logger.warn("delete_db 호출");
                databaseService.deleteDatabase(Integer.parseInt(request.getParameter("delete_db")));
