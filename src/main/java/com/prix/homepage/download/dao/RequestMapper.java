...
public interface RequestMapper {
    ...
    // void saveRequest(Timestamp date, String name, String affiliation,String title, String email, String instrument,String software, String version, int state, Timestamp senttime);
